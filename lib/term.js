...
// needs (list, text input, viewport). No dependencies — this is the whole
// bubbletea/bubbles/lipgloss surface cccsss actually used, reimplemented small.
...
// Filter states mirror the Go original: 'off', 'filtering', 'applied'.
class List {
